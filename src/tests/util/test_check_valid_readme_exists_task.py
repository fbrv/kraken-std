...
from kraken.std.util.check_valid_readme_exists_task import CheckValidReadmeExistsTask, ValidationErrors
...
def test__readme_content_is_not_allowed() -> None:
    ...
    assert result[ValidationErrors.CONTENT_NOT_ALLOWED]
